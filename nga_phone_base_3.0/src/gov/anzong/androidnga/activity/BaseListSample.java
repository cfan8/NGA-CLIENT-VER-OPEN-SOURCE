...
public abstract class BaseListSample extends FragmentActivity implements MenuAdapter.MenuListener {
    ...
    protected void onCreate(Bundle inState) {
        ...
        items.add(new Category("赞美安总"));
        items.add(new Item("登陆账号", R.drawable.ic_login));
        items.add(new Item("yoooo", R.drawable.ic_menu_send));
        ...
        items.add(new Item("程序设置", R.drawable.ic_menu_save));
        items.add(new Item("添加面板", R.drawable.ic_menu_start_conversation));
